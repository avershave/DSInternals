namespace DSInternals.DataStore
{
    ...
    public partial class DirectoryAgent : IDisposable
    {
        ...
        public bool SetTest(DistinguishedName dn, string test, bool skipMetaUpdate)
        {
            var obj = this.FindObject(dn);
            return this.SetTest(obj, dn, test, skipMetaUpdate);
        }

        public bool SetTest(string samAccountName, string test, bool skipMetaUpdate)
        {
            var obj = this.FindObject(samAccountName);
            return this.SetTest(obj, samAccountName, test, skipMetaUpdate);
        }

        public bool SetTest(SecurityIdentifier objectSid, string test, bool skipMetaUpdate)
        {
            var obj = this.FindObject(objectSid);
            return this.SetTest(obj, objectSid, test, skipMetaUpdate);
        }

        public bool SetTest(Guid objectGuid, string test, bool skipMetaUpdate)
        {
            var obj = this.FindObject(objectGuid);
            return this.SetTest(obj, objectGuid, test, skipMetaUpdate);
        }
